...
# **call_create**
> Call call_create(to_number, device_type, device_number, device_params, trunk=trunk, ticket_id=ticket_id)
...
try: 
    # Originate new call
    api_response = api_instance.call_create(to_number, device_type, device_number, device_params, trunk=trunk, ticket_id=ticket_id)
    pprint(api_response)
except ApiException as e:
